...
const principleColors = {
  'Perceivable': 'bg-pink-50 text-pink-700 dark:bg-pink-900/20 dark:text-pink-300',
  'Operable': 'bg-orange-50 text-orange-700 dark:bg-orange-900/20 dark:text-orange-300',
  'Understandable': 'bg-cyan-50 text-cyan-700 dark:bg-cyan-900/20 dark:text-cyan-300',
  'Robust': 'bg-emerald-50 text-emerald-700 dark:bg-emerald-900/20 dark:text-emerald-300'
};
